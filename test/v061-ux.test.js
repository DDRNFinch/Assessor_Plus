...
test('V0.7.8 identifiers and unique cache agree exactly',async()=>{
  ...
  assert.match(pdf,/ASSESSOR\+ V0\.7\.8(?:-shell-20260811)?/);
  assert.match(build,/Built Assessor\+ V0\.7\.8(?:-shell-20260811)?/);
