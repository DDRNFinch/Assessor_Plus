...
test('V0.7.2 identifiers and unique cache agree exactly',async()=>{
  ...
  assert.match(pdf,/ASSESSOR\+ V0\.7\.2/);
  assert.match(build,/Built Assessor\+ V0\.7\.2/);
  assert.match(sw,/const CACHE='assessor-plus-v0\.7\.2'/);
